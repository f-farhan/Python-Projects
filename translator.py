...
choose_language['values'] = ('Afrikaans','Albanian','Arabic','Armenian','Azerbaijani','Basque','Belarusian','Bengali','Bosnian','Bulgarian','Catalan','Cebuano','Chichewa','Chinese','Corsican','Croatian','Czech','Danish','Dutch','English','Esperanto','Estonian','Filipino','Finnish','French','Frisian','Galician','Georgian','German','Greek','Hausa','Hawaiian','Hebrew','Hindi','Hungarian','Icelandic','Igbo','Indonesian','Irish','Italian','Japanese','Javanese','Kannada','Kazakh','Korean','Kurdish','Lao','Latin','Luxembourgish','Malay','Malayam','Maori','Myanmar','Nepali','Portuguese','Romanian','Russian','Samoan','Sindhi','Swedish','Tajik','Tamil','Tatar','Turkish','Ukranian','Urdu','Vietnamese','Zulu',)
